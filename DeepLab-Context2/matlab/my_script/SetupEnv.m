...
clear all; close all;
addpath('/home/hlc/codes/PycharmProjects/rsBuildingSeg/DeepLab-Context2/matlab/my_script');
...
%
dataset    = '/media/hlc/DATA/Data_lingcao/aws_SpaceNet/deeplab_exper/spacenet_rgb_aoi_2'

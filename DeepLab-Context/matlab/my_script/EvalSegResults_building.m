...
VOC_root_folder = '/media/hlc/DATA/Data_lingcao/aws_SpaceNet/voc_format/AOI_2_Vegas_Train';
output_folder = '';
...
output_mat_folder = fullfile(output_folder, dataset, feature_name, model_name, testset, feature_type);

save_root_folder = fullfile(output_folder, dataset, feature_name, model_name, testset, feature_type, post_folder);
...
elseif strcmp(dataset, 'coco')
  ...
  gt_dir   = fullfile(VOC_root_folder, '', 'SegmentationClass');
elseif strcmp(dataset,'/media/hlc/DATA/Data_lingcao/aws_SpaceNet/voc_format/AOI_2_Vegas_Train')
    seg_res_dir = [save_root_folder '/results/AOI_2/'];
    seg_root = fullfile(VOC_root_folder, '');
    gt_dir   = fullfile(VOC_root_folder, '', 'SegmentationClass');
end
...
elseif strcmp(dataset,'/media/hlc/DATA/Data_lingcao/aws_SpaceNet/voc_format/AOI_2_Vegas_Train')
  VOCopts = GetVOCopts(seg_root, seg_res_dir, trainset, testset, 'AOI_2'); 
end

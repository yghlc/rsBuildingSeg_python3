...
clear all; close all;
addpath('/home/hlc/codes/PycharmProjects/rsBuildingSeg/DeepLab-Context/matlab/my_script');
...
%
dataset    = '/media/hlc/DATA/Data_lingcao/aws_SpaceNet/voc_format/AOI_2_Vegas_Train'
